...
* `mods/modpack/moddir` - Relative path to the mod
    * Must be one of the following:
        ...
        * `/path/to/env`: you can use absolute paths to mods inside folders specified with the `MINENTI_MOD_PATH` `env` variable (the legacy `MINETEST_MOD_PATH` is still honored).
